...
import { createUser, deleteUser, getAllUsers, getAllUsersWithProjects, getUserById, updateUser } from '../controllers/userController.js';
...
router.get('/withProjects', verifyToken, isProjectOrSuperAdmin, getAllUsersWithProjects)
